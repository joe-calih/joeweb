        ...
        >
          <div className="relative">
            ...
            <Input
              ...
              className="w-full pl-14 pr-28 py-6 text-lg bg-white/10 backdrop-blur-md border-white/20 rounded-2xl text-white placeholder-gray-400 focus:bg-white/15 focus:border-[#fc3c44] transition-all duration-300"
            />
            <div className="absolute right-2 inset-y-2">
              <button className="h-full bg-[#fc3c44] hover:bg-[#e63946] text-white px-6 rounded-xl transition-all duration-300 font-medium">
                Search
              </button>
            </div>
          </div>
