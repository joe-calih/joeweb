...
export function HomeSamplePacks() {
  return (
    <Section background="dark" padding="large">
      <div className="max-w-[1200px] mx-auto px-4">
        ...
        >
          <div>
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Featured Sample Packs</h2>
            ...
            >
              <Link href={`/samples/${pack.slug}`}>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-500 line-clamp-1">{pack.genre}</p>
                </div>
              </Link>
            </motion.div>
          ))}
