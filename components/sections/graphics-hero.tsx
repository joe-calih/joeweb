...
import { Play, ArrowRight, Palette, Download, Star } from "lucide-react"
      ...
      <div className="max-w-[1200px] mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
            ...
            >
              Premium <span className="text-[#fc3c44]">Graphics</span> & Design Resources
            </motion.h1>
            ...
            >
              Professional design templates, logos, icons, and visual assets to elevate your creative projects and brand
              identity.
            </motion.p>
            ...
            >
              <div className="text-center">
                ...
                <div className="text-sm text-gray-400">Design Assets</div>
              </div>
              <div className="text-center">
                <div className="flex justify-center mb-2">
              ...
              <div className="text-center">
                <div className="flex justify-center mb-2">
                  <Star className="w-8 h-8 text-[#fc3c44]" />
                </div>
            ...
            <div className="relative bg-gradient-to-br from-[#fc3c44] to-[#e63946] rounded-2xl p-8 shadow-2xl">
              <div className="bg-[#1a1a1a] rounded-xl p-6 space-y-4">
                <div className="flex items-center justify-between">
                  <h3 className="text-white font-semibold">Design Studio</h3>
